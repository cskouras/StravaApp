...
DEBUG = os.getenv("DEBUG", "False") == "True" # take out quotes?
...
AUTHENTICATION_BACKENDS = (
    'social_core.backends.strava.StravaOAuth', # or BaseOAuth2?
    'django.contrib.auth.backends.ModelBackend',
)
SOCIAL_AUTH_LOGIN_REDIRECT_URL = '/connected/'
SOCIAL_AUTH_STRAVA_SCOPE = ['activity:read_all']
SOCIAL_AUTH_STRAVA_KEY = '118491' #Client ID from API Application
